...
type PackingTripRouteClientProps = {
  tripId: string;
};

export function PackingTripRouteClient({ tripId }: PackingTripRouteClientProps) {
  ...
  if (!trip) {
    return (
      <RouteState
        ...
        description="Open eerst een bekende reis voordat je de inpaklijst bekijkt."
        actionLabel="Terug naar reizen"
      />
    );
  }

  return <PackingListPageClient trip={trip} />;
}
