...
type TasksRouteClientProps = {
  tripId: string;
};

export function TasksRouteClient({ tripId }: TasksRouteClientProps) {
  ...
  if (!trip) {
    return (
      <RouteState
        ...
        description="Open eerst een bekende reis voordat je taken bekijkt."
        actionLabel="Terug naar reizen"
      />
    );
  }

  return <TasksPageClient trip={trip} />;
}
